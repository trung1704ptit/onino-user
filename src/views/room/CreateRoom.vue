  ...
  <section class="bg-light m-15">
    ...
    <div class="room-list">
      <div
        ...
        :key="index"
        class="box room-block block-shadow"
        :class="groupIconUrl == icon ? 'active' : ''"
    ...
    <el-form
      ...
      :rules="roomRules"
      autocomplete="off"
      class="app-form form-wrapper box block-shadow section"
      label-position="left"
    >
...
export default {
  data() {
    return {
      groupIcons: [],
      groupIconUrl:
        "https://s3.ap-southeast-1.amazonaws.com/stg.onino.icons/group/defaultRoom.png",
      roomForm: {
        roomName: ""
      },
      roomRules: {
