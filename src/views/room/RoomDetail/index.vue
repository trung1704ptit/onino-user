            ...
            <el-col :xs="24" :sm="24" :lg="19">
                ...
                <div class="mt-15 mb-15">
                    ...
                    <div class="horizontal-list flex">
                        <room-device v-for="(device, index) in horizontalDevices" :key="device.deviceId + index" :handleEditDevice="handleClickEditDevice" :device="device" :inlineBlock="true" hasSwitch />
...
export default {
    ...
    mounted() {
        ...
        this.$store.dispatch('room/getRoomDevices', roomId).then(response => {
            ...
            const groups = deviceTypes.filter(type => this.roomDevices.some(item => item.deviceType === type.deviceType));
    ...
    methods: {
        ...
        handleSelectDevice(group) {
            ...
            this.groupDevices =  this.roomDevices.filter(item => item.deviceType === group.deviceType);
        }
    },
    computed: {
