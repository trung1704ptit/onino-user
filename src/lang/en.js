export default {
  ...
  login: {
    ...
    passwordError1: 'Password must have at least 6 degits',
    any: 'any',
  ...
  forgotPassword: {
    ...
    sendGuide: 'Send guideline for me'
  },
  register: {
    register: 'Register',
  ...
  page404: {
    notFound: 'We are sorry, the page you are requested is not available',
    ensureMessage: 'Please check your URL again or click on below button to back home.',
